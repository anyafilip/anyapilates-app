    ...
    <header className="relative z-50 w-full shrink-0">
      ...
      `}>
        ...
        <div className="px-4 pb-8 space-y-2">
          ...
          <form action={logout}>
            <button type="submit" className="w-full px-3 py-3 text-sm font-light text-white/50 hover:text-white hover:bg-white/10 rounded-lg text-left transition-colors">
              ← Logout
            </button>
          </form>
        </div>
