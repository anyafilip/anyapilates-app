    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      {pendingTotal > 0 && (
        <div className="bg-[#FAF5F0] border border-[#E8DFD5] rounded-2xl md:rounded-3xl p-5 md:p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm">
          ...
          <Link href="/admin/payments" className="w-full md:w-auto text-center bg-orange-600 text-white px-6 py-2.5 rounded-full text-[10px] tracking-widest uppercase hover:bg-orange-700 transition-colors">
            Review Payments
          </Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        ...
        <div className="bg-white/50 backdrop-blur-lg border border-white/60 rounded-3xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          <div className="flex justify-between items-end mb-6 border-b border-black/5 pb-4">
            ...
            <Link href="/admin/schedule" className="text-[10px] tracking-[0.2em] uppercase text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors border-b border-transparent hover:border-[var(--foreground)] pb-1">
              Full Calendar →
            </Link>
          </div>
        ...
        <div className="bg-white/50 backdrop-blur-lg border border-white/60 rounded-3xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          <div className="flex justify-between items-end mb-6 border-b border-black/5 pb-4">
            ...
            <Link href="/admin/payments" className="text-[10px] tracking-[0.2em] uppercase text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors border-b border-transparent hover:border-[var(--foreground)] pb-1">
              All Payments →
            </Link>
          </div>
